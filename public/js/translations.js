...
$(document).ready(function () {
    ...
    $.fn.alorse_editable = function (options) {
        var defaults = {},
        ...
        this.each(function () {
            ...
            elem.editable().on('hidden.alorse', function (e, reason) {
                var locale = $(this).data('locale');
                var elemRow = $(this).parents('tr').first();
                var trans = elemRow.find('a.alorse_editable'), tmp;
            ...
            elem.editable().on('shown.alorse', function (e, editable) {
    ...
    $('.alorse_editable').alorse_editable();
