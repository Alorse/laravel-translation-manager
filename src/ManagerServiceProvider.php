...
class ManagerServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(self::PACKAGE, function ($app) {
            /* @var $manager \Alorse\TranslationManager\Manager */
            $manager = $app->make('Alorse\TranslationManager\Manager');
            return $manager;
        });
    ...
    public function boot(Router $router)
    {
        ...
        $config['namespace'] = 'Alorse\TranslationManager';
        ...
        $router->pushMiddlewareToGroup('web', 'Alorse\TranslationManager\RouteAfterMiddleware');
    }
